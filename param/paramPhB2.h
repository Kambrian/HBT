	...
	/*=========program IO params==========*/
	#define SUBCAT_DIR  "/gpfs/data/jvbq85/HBT/data/PhB2/subcat"			//the output directory for subcatalogues and srccatalogues, this must be an existing directory
	//necessary sub-dirs: splitters,pro2dest,history
	#define GRPCAT_DIR  "/gpfs/data/Phoenix/phb-2/"				//the input directory for GrpCatalogues
	...
	/*======simulation params===========*/
	#define NP_SIM	459503436LL//total Number of all kinds of particles;
	#define NP_GAS 	0
	#define NP_DM  422607600LL//
	#define BOXSIZE 	500.0  //Mpc/h
	#define MP_DM   6.127263e-04
	#define MP_GAS   0.
