...
#endif
	/*=========program IO params==========*/
	#define SUBCAT_DIR  "/home/jxhan/6145/subcat"			//the output directory for subcatalogues and srccatalogues, this must be an existing directory
	#define GRPCAT_DIR  "/home/jxhan/6145/fof"				     //the input directory for GrpCatalogues
	#define SNAPSHOT_DIR  "/home/jxhan/6145/simu"				//the input directory for simulation snapshots
