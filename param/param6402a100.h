...
//this simulation is done on mppg altix350 server, with a restart so duplicate redshifts for two snapshots
	
	/*=========program IO params==========*/
	#define GASCAT_DIR  "/home/kambrain/data/6402a100/gascat"			//the output directory for gashalocat,gassubcat and gassrccat, this must be an existing directory
	#define SUBCAT_DIR  "/home/kambrain/data/6402a100/subcat"			//the output directory for subcatalogues and srccatalogues, this must be an existing directory
	//necessary sub-dirs: splitters,pro2dest,history
	#define GRPCAT_DIR  "/home/kambrain/data/6402a100/fof"				//the input directory for GrpCatalogues
	#define SNAPSHOT_DIR  "/home/kambrain/data/6402a100/simu"					//the input directory for simulation snapshots
	#define LOGFILE_NAME  "logfile"																			//the name of program logfile, set to "stdout" to use stdout

	/*======simulation params===========*/
	#define NP_SIM	1421186 //total Number of all kinds of particles
	#define NP_gas 	266831
	#define NP_DM 	266831
	#define BOXSIZE 	100000.0
	//#define partmass=0.000554157,9.77924e-05

	/*=======Tree algorithm params========*/
	#define TREE_ALLOC_FACTOR 2//  MaxNodes = ((maxnodes>500)?maxnodes:500);
	#define ErrTolTheta 0.45
	#define SofteningHalo 0.7
	#define NodeResolution 0.07  //0.1*Softening
	#define NodeReso_half 0.035
