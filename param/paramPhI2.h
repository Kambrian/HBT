	...
	/*=========program IO params==========*/
	#define SUBCAT_DIR  "/gpfs/data/jvbq85/HBT/data/PhI2/subcat"			//the output directory for subcatalogues and srccatalogues, this must be an existing directory
	//necessary sub-dirs: splitters,pro2dest,history
	#define GRPCAT_DIR  "/gpfs/data/Phoenix/phi-2/"				//the input directory for GrpCatalogues
	...
	/*======simulation params===========*/
	#define NP_SIM	567573052LL//total Number of all kinds of particles;
	#define NP_GAS 	0
	#define NP_DM  531555250LL//
	#define BOXSIZE 	500.0  //Mpc/h
	#define MP_DM   0.00184063
	#define MP_GAS   0.
