	...
	#define HALO_PARA
	/*=========program IO params==========*/
	#define SUBCAT_DIR  "/home/kambrain/data2/6141/subcat"			//the output directory for subcatalogues and srccatalogues, this must be an existing directory
	#define GRPCAT_DIR  "/home/kambrain/data2/6141/fof"				     //the input directory for GrpCatalogues
	#define SNAPSHOT_DIR  "/home/kambrain/data2/6141/simu"				//the input directory for simulation snapshots
	...
	#define RUN_NUM 6141   //simulation name
