	...
	#define SUBCAT_DIR  "/home/jvbq85/data/HBT/data/AqA4/subcatRelaxInf"			//the output directory for subcatalogues and srccatalogues, this must be an existing directory
