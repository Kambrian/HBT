	...
	#define SUBCAT_DIR  "/gpfs/data/jvbq85/HBT/data/AqA4/subcatRelax9"			//the output directory for subcatalogues and srccatalogues, this must be an existing directory
