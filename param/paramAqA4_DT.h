	...
	#define SUBCAT_DIR  "/gpfs/data/jvbq85/HBT/data/AqA4/subcatDT"			//the output directory for subcatalogues and srccatalogues, this must be an existing directory
	...
	#define MaxSnap 50//total number of snapshot outputs
