	...
	/*=========program IO params==========*/
	#define GASCAT_DIR  "/gpfs/data/jvbq85/HBT/data/AqA3/gascat"			//the output directory for gashalocat,gassubcat and gassrccat, this must be an existing directory
	#define SUBCAT_DIR  "/gpfs/data/jvbq85/HBT/data/AqA3/subcatRelaxInf"			//the output directory for subcatalogues and srccatalogues, this must be an existing directory
