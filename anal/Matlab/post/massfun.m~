...
load([datadir,'sub_mass_099']);
load([datadir,'group_offset_099']);
% sub_mass_099=sub_mass_070;
% group_offset_099=group_offset_070;
...
loglog(x(2:nbin),summass(nbin:-1:2),'-- sc');
...
%%
cd /home/kam/Documents/research/Galaxy/code/BoundTracing/v7.1/data/massfun/6702low
