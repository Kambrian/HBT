	...
	/*=========program IO params==========*/
	#define GASCAT_DIR  "/home/kambrain/data/6500/gascat"			//the output directory for gashalocat,gassubcat and gassrccat, this must be an existing directory
	#define SUBCAT_DIR  "/home/kambrain/data/6500/subcat"							//the output directory for subcatalogues and srccatalogues, this must be an existing directory
	#define GRPCAT_DIR  "/home/kambrain/data/6500/fof"		//the input directory for GrpCatalogues
	#define  SNAPSHOT_DIR  "/home/kambrain/data/6500/simu"																//the input directory for simulation snapshots
	...
	/*======simulation params===========*/
	#define NP_SIM	 71096864 //total Number of all kinds of particles
	#define NP_gas 27098058
	#define NP_DM 27098058
	#define BOXSIZE 100000.0
	//#define partmass=7.44348e-05 %DM mass; for baryon: partmass=1.31355e-05
