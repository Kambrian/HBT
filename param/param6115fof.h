...
#endif
	/*=========program IO params==========*/
	#define SUBCAT_DIR  "/home/kambrain/data8/6115/subcat"			//the output directory for subcatalogues and srccatalogues, this must be an existing directory
	#define GRPCAT_DIR  "/home/kambrain/data8/6115/fof2"				     //the input directory for GrpCatalogues
	#define SNAPSHOT_DIR  "/home/kambrain/data8/6115/simu"				//the input directory for simulation snapshots
	...
	#define BOXSIZE 150000.0
	#define MP_GAS 0.
	#define MP_DM 0.0233803
	/*=extension params=*/
	#define BOXHALF 75000.0
	#define OMEGA0 0.268
	...
	#define SofteningHalo 1.667  //ita=5 kpc/h ,epsilon=ita/3
	#define NodeResolution 0.1667  //0.1*Softening
	#define NodeReso_half 0.0833
	...
	#define MaxSnap 99//total number of snapshot outputs
	
	#define RUN_NUM 6115   //simulation name
