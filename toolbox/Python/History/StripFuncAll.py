...
for H in hlist:
  Halo[H]=HaloData(H)
Mhalo=np.array([Halo[h].Mvir for h in hlist]).reshape([2,-1]).mean(1)
chalo=np.array([Halo[h].Cvir for h in hlist]).reshape([2,-1]).mean(1)
