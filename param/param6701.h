	...
	/*=========program IO params==========*/
	#define GASCAT_DIR  "/home/kambrain/data/6701/gascat"			//the output directory for gashalocat,gassubcat and gassrccat, this must be an existing directory
	#define SUBCAT_DIR  "/home/kambrain/data/6701/subcat"			//the output directory for subcatalogues and srccatalogues, this must be an existing directory
	#define GRPCAT_DIR  "/home/kambrain/data/6701/fof"				//the input directory for GrpCatalogues
	#define  SNAPSHOT_DIR  "/home/kambrain/data/6701/simu"					//the input directory for simulation snapshots
	#define LOGFILE_NAME  "logfile"																			//the name of program logfile, set to "stdout" to use stdout

	/*======simulation params===========*/
	#define NP_SIM	85262806 //total Number of all kinds of particles
	#define NP_gas 	26947376
	#define NP_DM 	26947376
	#define BOXSIZE 	300000.0
	//#define partmass=0.00834475,0.0014726
