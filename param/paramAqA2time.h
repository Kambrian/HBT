//for program timing test
#ifndef PARAM_FILE_INCLUDED	//to avoid multiple inclusion
	
	/*=========program IO params==========*/
	#define SUBCAT_DIR  "/home/jvbq85/data/HBT/data/AqA2/subcattime"			//the output directory for subcatalogues and srccatalogues, this must be an existing directory
...
//	#define CONVERT_LENGTH_MPC_KPC //this tells to convert unit from Mpc to kpc, 
	...
	#define MaxSnap 123//total number of snapshot outputs
	#define SNAPFILE_BASE "snap_C021200"
	#define SNAPLIST  1121     //snaplist identifier to enable the corresponding snaplist in iovars.c
