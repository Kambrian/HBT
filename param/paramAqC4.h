	...
	/*=========program IO params==========*/
	#define ROOT_DIR "/home/jvbq85/data/HBT/data/AqC4"			//the output directory for gashalocat,gassubcat and gassrccat, this must be an existing directory
	...
	#define GRPCAT_DIR  "/gpfs/data/aquarius/halo_data/Aq-C/4"				//the input directory for GrpCatalogues
	#define  SNAPSHOT_DIR  "/gpfs/data/aquarius/halo_data/Aq-C/4"					//the input directory for simulation snapshots
	#define LOGFILE_NAME  "logfile"																			//the name of program logfile, set to "stdout" to use stdout

	/*======simulation params===========*/
	#define NP_SIM	27292287LL //total Number of all kinds of particles
	#define NP_GAS 	0
	#define NP_DM 	26679146LL
	#define BOXSIZE 	100.0  //Mpc/h
	#define MP_DM   2.345450e-05
	#define MP_GAS   0.
...
//	#define CONVERT_LENGTH_MPC_KPC //this tells to convert unit from Mpc to kpc, 
	...
	#define SNAPFILE_BASE "snap_C09_400"
