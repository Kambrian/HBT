	...
	#define SUBCAT_DIR  "/gpfs/data/jvbq85/HBT/data/AqA3/subcattime"			//the output directory for subcatalogues and srccatalogues, this must be an existing directory
