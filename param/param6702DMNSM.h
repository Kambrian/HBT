	...
	/*=========program IO params==========*/
	#define SUBCAT_DIR  "/home/kambrain/data/6702DMNSM/subcat"			//the output directory for subcatalogues and srccatalogues, this must be an existing directory
	#define GRPCAT_DIR  "/home/kambrain/data/6702DMNSM/fof"				//the input directory for GrpCatalogues
	#define  SNAPSHOT_DIR  "/home/kambrain/data/6702DMNSM/simu"					//the input directory for simulation snapshots
