...
//done on USTC server	
	/*=========program IO params==========*/
	#define GASCAT_DIR  "/home/kambrain/data/6402U10/gascat"			//the output directory for gashalocat,gassubcat and gassrccat, this must be an existing directory
	#define SUBCAT_DIR  "/home/kambrain/data/6402U10/subcat"			//the output directory for subcatalogues and srccatalogues, this must be an existing directory
	//necessary sub-dirs: splitters,pro2dest,history
	#define GRPCAT_DIR  "/home/kambrain/data/6402U10/fof"				//the input directory for GrpCatalogues
	#define SNAPSHOT_DIR  "/home/kambrain/data/6402U10/simu"					//the input directory for simulation snapshots
	#define LOGFILE_NAME  "logfile"																			//the name of program logfile, set to "stdout" to use stdout

	/*======simulation params===========*/
	#define NP_SIM	6964149 //total Number of all kinds of particles
	#define NP_gas 	2684384
	#define NP_DM 	2684384
