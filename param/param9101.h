...
#endif
	/*=========program IO params==========*/
	#define ROOT_DIR "/home/jxhan/d8/9101/"
	...
	/*======simulation params===========*/
	#define NP_SIM	8589934592 //total Number of all kinds of particles
	#define NP_GAS 0
	#define NP_DM 8589934592
	#define BOXSIZE 400000.0
	/*=extension params=*/
	#define BOXHALF 200000.0
	#define OMEGA0 0.315
	#define OMEGAL0 0.685
	...
	#define SofteningHalo 2.3  //ita=7 kpc/h ,epsilon=ita/3
	#define NodeResolution 0.23  //0.1*Softening
	#define NodeReso_half 0.115
	...
	#define RUN_NUM 9101   //simulation name
