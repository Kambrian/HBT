	...
	/*=========program IO params==========*/
	#define GASCAT_DIR  "/home/kambrain/data/6506/gascat"			//the output directory for gashalocat,gassubcat and gassrccat, this must be an existing directory
	#define SUBCAT_DIR  "/home/kambrain/data/6506/subcat"							//the output directory for subcatalogues and srccatalogues, this must be an existing directory
	#define GRPCAT_DIR  "/home/kambrain/data/6506/fof"		//the input directory for GrpCatalogues
	#define  SNAPSHOT_DIR  "/home/kambrain/data/6506/simu"																//the input directory for simulation snapshots
	...
	/*======simulation params===========*/
	#define NP_SIM	 76652437 //total Number of all kinds of particles
	#define NP_gas 26926925
	#define NP_DM 26926925
	#define BOXSIZE 100000.0
	//#define partmass=6.45321e-05 %DM mass; for baryon: partmass=1.1388e-05
