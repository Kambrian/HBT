	...
	#define HALO_PARA
	/*=========program IO params==========*/
	#define ROOT_DIR    "/home/jvbq85/data/HBT/data/BJLF6"
	...
	#define  SNAPSHOT_DIR  "/gpfs/data/bl267/test_ramses_fr/data/B250-PM1024/F6"	//the input directory for simulation snapshots
