	...
	/*=========program IO params==========*/
	#define SUBCAT_DIR  "/gpfs/data/jvbq85/HBT/data/PhF2/subcat"			//the output directory for subcatalogues and srccatalogues, this must be an existing directory
	//necessary sub-dirs: splitters,pro2dest,history
	#define GRPCAT_DIR  "/gpfs/data/Phoenix/phf-2/"				//the input directory for GrpCatalogues
	...
	/*======simulation params===========*/
	#define NP_SIM	425704705LL//total Number of all kinds of particles;
	#define NP_GAS 	0
	#define NP_DM  387990369LL//
	#define BOXSIZE 	500.0  //Mpc/h
	#define MP_DM   0.000621942
	#define MP_GAS   0.
