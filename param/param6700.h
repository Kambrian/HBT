	...
	/*=========program IO params==========*/
	#define GASCAT_DIR  "/home/kambrain/data/6700/gascat"			//the output directory for gashalocat,gassubcat and gassrccat, this must be an existing directory
	#define SUBCAT_DIR  "/home/kambrain/data/6700/subcat"			//the output directory for subcatalogues and srccatalogues, this must be an existing directory
	#define GRPCAT_DIR  "/home/kambrain/data/6700/fof"				//the input directory for GrpCatalogues
	#define  SNAPSHOT_DIR  "/home/kambrain/data/6700/simu"					//the input directory for simulation snapshots
	#define LOGFILE_NAME  "logfile"																			//the name of program logfile, set to "stdout" to use stdout

	/*======simulation params===========*/
	#define NP_SIM	110538880 //total Number of all kinds of particles
	#define NP_gas 	26985855
	#define NP_DM 	26985855
	#define BOXSIZE 	300000.0
	//#define partmass=0.0130057,0.00229512
