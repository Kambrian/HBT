...
#endif
	/*=========program IO params==========*/
	#define ROOT_DIR "/home/jxhan/d8/8511/"
	...
	#define SofteningHalo 3.4  //ita=13 kpc/h ,epsilon=ita/3
	#define NodeResolution 0.34  //0.1*Softening
	#define NodeReso_half 0.17
	...
	#define RUN_NUM 8511   //simulation name
