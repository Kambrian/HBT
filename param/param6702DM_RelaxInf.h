	...
	/*=========program IO params==========*/
	#define SUBCAT_DIR  "/home/kambrain/data/6702DM/subcatRelaxInf"			//the output directory for subcatalogues and srccatalogues, this must be an existing directory
