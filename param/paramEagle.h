	...
	#define GRPCAT_DIR  "/gpfs/data/EagleVolume/snapshots"				//the input directory for GrpCatalogues
	#define  SNAPSHOT_DIR  "/gpfs/data/EagleVolume/snapshots"					//the input directory for simulation snapshots
