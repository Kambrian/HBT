	...
	/*=========program IO params==========*/
	#define GASCAT_DIR  "/home/kambrain/data/6402/gascat"			//the output directory for gashalocat,gassubcat and gassrccat, this must be an existing directory
	#define SUBCAT_DIR  "/home/kambrain/data/6402/subcat"			//the output directory for subcatalogues and srccatalogues, this must be an existing directory
	//necessary sub-dirs: splitters,pro2dest,history
	#define GRPCAT_DIR  "/home/kambrain/data/6402/fof"				//the input directory for GrpCatalogues
	#define  SNAPSHOT_DIR  "/home/kambrain/data/6402/simu"					//the input directory for simulation snapshots
	...
	/*======simulation params===========*/
	#define NP_SIM	62560365 //total Number of all kinds of particles
	#define NP_gas 	27022740
	#define NP_DM 	27022740
	#define BOXSIZE 	100000.0
	//#define partmass=5.45271e-6,9.62243e-7
