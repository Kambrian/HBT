	...
	/*=========program IO params==========*/
	#define GASCAT_DIR  "/home/kambrain/data/6404/gascat"			//the output directory for gashalocat,gassubcat and gassrccat, this must be an existing directory
	#define SUBCAT_DIR  "/home/kambrain/data/6404/subcat"			//the output directory for subcatalogues and srccatalogues, this must be an existing directory
	//necessary sub-dirs: splitters,pro2dest,history
	#define GRPCAT_DIR  "/home/kambrain/data/6404/fof"				//the input directory for GrpCatalogues
	#define  SNAPSHOT_DIR  "/home/kambrain/data/6404/simu"					//the input directory for simulation snapshots
	...
	/*======simulation params===========*/
	#define NP_SIM	70551910 //total Number of all kinds of particles
	#define NP_gas 	27006332
	#define NP_DM 	27006332
	#define BOXSIZE 	100000
	//#define partmass=5.29086e-06,9.33681e-07

	/*=======Tree algorithm params========*/
	#define TREE_ALLOC_FACTOR 2//  MaxNodes = ((maxnodes>500)?maxnodes:500);
	#define ErrTolTheta 0.45
	#define SofteningHalo 0.15
	#define NodeResolution 0.015  //0.1*Softening
	#define NodeReso_half 0.0075
