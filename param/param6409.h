	...
	/*=========program IO params==========*/
	#define GASCAT_DIR  "/home/kambrain/data/6409/gascat"			//the output directory for gashalocat,gassubcat and gassrccat, this must be an existing directory
	#define SUBCAT_DIR  "/home/kambrain/data/6409/subcat"			//the output directory for subcatalogues and srccatalogues, this must be an existing directory
	//necessary sub-dirs: splitters,pro2dest,history
	#define GRPCAT_DIR  "/home/kambrain/data/6409/fof"				//the input directory for GrpCatalogues
	#define  SNAPSHOT_DIR  "/home/kambrain/data/6409/simu"					//the input directory for simulation snapshots
	...
	/*======simulation params===========*/
	#define NP_SIM	66477014 //total Number of all kinds of particles
	#define NP_gas 	26965233
	#define NP_DM 	26965233
	#define BOXSIZE 	100000.0
	//#define partmass=5.23311e-06,9.23491e-07
