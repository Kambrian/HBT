...
#endif
	/*=========program IO params==========*/
	#define ROOT_DIR  "/home/jxhan/data/HBT/data/HY3002Nd20012"			//the output directory for gashalocat,gassubcat and gassrccat, this must be an existing directory
	...
	#define GRPCAT_DIR  ROOT_DIR"/simu"				//the input directory for GrpCatalogues
	...
	/*======simulation params===========*/
	#define NP_SIM	134217728LL //total Number of all kinds of particles
	#define NP_GAS 	0
	#define NP_DM 	134217728LL
	#define BOXSIZE  300.  //Mpc/h
	#define BOXHALF 150.
	#define MP_DM    1.440505
	#define MP_GAS   0.

	/*=======Tree algorithm params========*/
	#define TREE_ALLOC_FACTOR 2//  MaxNodes = ((maxnodes>500)?maxnodes:500);
	#define ErrTolTheta 0.45
	#define SofteningHalo 0.012  //Mpc/h
	#define NodeResolution 0.0012  //0.1*Softening
	#define NodeReso_half 0.0006
