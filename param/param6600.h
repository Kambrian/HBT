	...
	/*=========program IO params==========*/
	#define GASCAT_DIR  "/home/kambrain/data/6600/gascat"			//the output directory for gashalocat,gassubcat and gassrccat, this must be an existing directory
	#define SUBCAT_DIR  "/home/kambrain/data/6600/subcat"			//the output directory for subcatalogues and srccatalogues, this must be an existing directory
	#define GRPCAT_DIR  "/home/kambrain/data/6600/fof"				//the input directory for GrpCatalogues
	#define  SNAPSHOT_DIR  "/home/kambrain/data/6600/simu"					//the input directory for simulation snapshots
	...
	/*======simulation params===========*/
	#define NP_SIM	65232037 //total Number of all kinds of particles
	#define NP_gas 	27032922
	#define NP_DM 	27032922
	#define BOXSIZE 	300000.0
	//#define partmass=0.000139376,0.000789798

	/*=======Tree algorithm params========*/
	#define TREE_ALLOC_FACTOR 2//  MaxNodes = ((maxnodes>500)?maxnodes:500);
	#define ErrTolTheta 0.45
	#define SofteningHalo 0.69
	#define NodeResolution 0.069  //0.1*Softening
	#define NodeReso_half 0.0345
