	...
	#define SUBCAT_DIR  "/gpfs/data/jvbq85/HBT/data/AqA4/subcatSkip4"			//the output directory for subcatalogues and srccatalogues, this must be an existing directory
	...
	#define MaxSnap 256//total number of snapshot outputs
