	...
	#define SUBCAT_DIR  "/gpfs/data/jvbq85/HBT/data/AqA4/subcatRelax4"			//the output directory for subcatalogues and srccatalogues, this must be an existing directory
	...
	#define E_Relax 4  //(E_Relax+1)*pot+K<0
