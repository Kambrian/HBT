	...
	/*=========program IO params==========*/
	#define SUBCAT_DIR  "/gpfs/data/jvbq85/HBT/data/PhG2/subcat"			//the output directory for subcatalogues and srccatalogues, this must be an existing directory
	//necessary sub-dirs: splitters,pro2dest,history
	#define GRPCAT_DIR  "/gpfs/data/Phoenix/phg-2/"				//the input directory for GrpCatalogues
	...
	/*======simulation params===========*/
	#define NP_SIM	535319792LL//total Number of all kinds of particles;
	#define NP_GAS 	0
	#define NP_DM  503414880LL//
	#define BOXSIZE 	500.0  //Mpc/h
	#define MP_DM   0.000859943
	#define MP_GAS   0.
