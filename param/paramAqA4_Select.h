	...
	#define SUBCAT_DIR  "/gpfs/data/jvbq85/HBT/data/AqA4/subcatSelect"			//the output directory for subcatalogues and srccatalogues, this must be an existing directory
	...
	#define MaxSnap 59//total number of snapshot outputs
