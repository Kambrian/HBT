...
#endif
	/*=========program IO params==========*/
	#define SUBCAT_DIR  "/data/A4700r2d1/kambrain/6123/subcat"			//the output directory for subcatalogues and srccatalogues, this must be an existing directory
	#define GRPCAT_DIR  "/data/A4700r2d1/kambrain/6123/fof"				     //the input directory for GrpCatalogues
	#define SNAPSHOT_DIR  "/data/A4700r2d1/kambrain/6123/simu"				//the input directory for simulation snapshots
	...
	#define RUN_NUM 6123   //simulation name
