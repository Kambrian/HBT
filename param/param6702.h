	...
	/*=========program IO params==========*/
	#define GASCAT_DIR  "/home/kambrain/data/6702/gascat"			//the output directory for gashalocat,gassubcat and gassrccat, this must be an existing directory
	#define SUBCAT_DIR  "/home/kambrain/data/6702/subcat"			//the output directory for subcatalogues and srccatalogues, this must be an existing directory
	//necessary sub-dirs: splitters,pro2dest,history
	#define GRPCAT_DIR  "/home/kambrain/data/6702/fof"				//the input directory for GrpCatalogues
	#define  SNAPSHOT_DIR  "/home/kambrain/data/6702/simu"					//the input directory for simulation snapshots
	//~ #define SUBCAT_DIR  "/home/kambrain/sd8/6702/subcat/NoSatMerg"			//the output directory for subcatalogues and srccatalogues, this must be an existing directory
	//~ #define GRPCAT_DIR  "/home/kambrain/sd8/6702/fof"				//the input directory for GrpCatalogues
	//~ #define  SNAPSHOT_DIR  "/home/kambrain/sd8/6702/simu"					//the input directory for simulation snapshots
	#define LOGFILE_NAME  "logfile"																			//the name of program logfile, set to "stdout" to use stdout

	/*======simulation params===========*/
	#define NP_SIM	84347747 //total Number of all kinds of particles
	#define NP_gas 	27040190
	#define NP_DM 	27040190
	#define BOXSIZE 	300000.0
	//#define partmass=0.008848,0.00156133
