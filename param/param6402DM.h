	...
	/*=========program IO params==========*/
	#define GASCAT_DIR  "/home/kambrain/data/6402DM/gascat"			//the output directory for gashalocat,gassubcat and gassrccat, this must be an existing directory
	#define SUBCAT_DIR  "/home/kambrain/data/6402DM/subcat"			//the output directory for subcatalogues and srccatalogues, this must be an existing directory
	//necessary sub-dirs: splitters,pro2dest,history
	#define GRPCAT_DIR  "/home/kambrain/data/6402DM/fof"				//the input directory for GrpCatalogues
	#define  SNAPSHOT_DIR  "/home/kambrain/data/6402DM/simu"					//the input directory for simulation snapshots
	...
	/*======simulation params===========*/
	#define NP_SIM	35537625 //total Number of all kinds of particles
	#define NP_gas 	0
