	...
	#define  SNAPSHOT_DIR  "/gpfs/data/aquarius/halo_data/Aq-E/4"					//the input directory for simulation snapshots
	#define LOGFILE_NAME  "logfile"																			//the name of program logfile, set to "stdout" to use stdout

	/*======simulation params===========*/
	#define NP_SIM	17793102LL //total Number of all kinds of particles
	#define NP_GAS 	0
	#define NP_DM 17159996LL
	#define BOXSIZE 	100.0  //Mpc/h
	#define MP_DM 1.901250e-05 
	#define MP_GAS   0.
...
//	#define CONVERT_LENGTH_MPC_KPC //this tells to convert unit from Mpc to kpc, 
	...
	#define SNAPFILE_BASE "snap_9_1_53_400"
