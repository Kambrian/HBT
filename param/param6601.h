	...
	/*=========program IO params==========*/
	#define GASCAT_DIR  "/home/kambrain/data/6601/gascat"			//the output directory for gashalocat,gassubcat and gassrccat, this must be an existing directory
	#define SUBCAT_DIR  "/home/kambrain/data/6601/subcat"			//the output directory for subcatalogues and srccatalogues, this must be an existing directory
	#define GRPCAT_DIR  "/home/kambrain/data/6601/fof"				//the input directory for GrpCatalogues
	#define  SNAPSHOT_DIR  "/home/kambrain/data/6601/simu"					//the input directory for simulation snapshots
	...
	/*======simulation params===========*/
	#define NP_SIM	67540046 //total Number of all kinds of particles
	#define NP_gas 	27082808
	#define NP_DM 	27082808
	#define BOXSIZE 	300000.0
	//#define partmass=0.000670876,0.00011839
