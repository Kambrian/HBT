	...
	/*=========program IO params==========*/
	#define GASCAT_DIR  "/home/kambrain/data/6602/gascat"			//the output directory for gashalocat,gassubcat and gassrccat, this must be an existing directory
	#define SUBCAT_DIR  "/home/kambrain/data/6602/subcat"			//the output directory for subcatalogues and srccatalogues, this must be an existing directory
	#define GRPCAT_DIR  "/home/kambrain/data/6602/fof"				//the input directory for GrpCatalogues
	#define  SNAPSHOT_DIR  "/home/kambrain/data/6602/simu"					//the input directory for simulation snapshots
	...
	/*======simulation params===========*/
	#define NP_SIM	63333111 //total Number of all kinds of particles
	#define NP_gas 	26979842
	#define NP_DM 	26979842
	#define BOXSIZE 	300000.0
	//#define partmass=0.000546019,9.63564e-05
