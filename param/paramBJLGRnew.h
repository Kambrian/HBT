...
#endif
	/*=========program IO params==========*/
	#define ROOT_DIR    "/gpfs/data/jvbq85/HBT/data/BJLGRnew"
	...
	#define BOXSIZE  64000.0  //kpc/h
	#define MP_DM    1.523152e-02
	#define MP_GAS   0.
	#define BOXHALF 32000.0

	/*=======Tree algorithm params========*/
	#define TREE_ALLOC_FACTOR 1//  MaxNodes = ((maxnodes>500)?maxnodes:500);
	#define ErrTolTheta 0.45
	#define SofteningHalo 1  //kpc/h
	#define NodeResolution 0.1  //0.1*Softening
	#define NodeReso_half 0.05
...
//	#define CONVERT_LENGTH_MPC_KPC //this tells to convert unit from Mpc to kpc, 
	...
	#define IniSnap 1
	#define MaxSnap 63//total number of snapshot outputs
	#define SNAPFILE_BASE "GR"
	#define NFILES 240   //number of files per snapshot
