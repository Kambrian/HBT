	...
	/*=========program IO params==========*/
	#define GASCAT_DIR  "/home/kambrain/data/6402U100/gascat"			//the output directory for gashalocat,gassubcat and gassrccat, this must be an existing directory
	#define SUBCAT_DIR  "/home/kambrain/data/6402U100/subcat"			//the output directory for subcatalogues and srccatalogues, this must be an existing directory
	//necessary sub-dirs: splitters,pro2dest,history
	#define GRPCAT_DIR  "/home/kambrain/data/6402U100/fof"				//the input directory for GrpCatalogues
	#define SNAPSHOT_DIR  "/home/kambrain/data/6402U100/simu"					//the input directory for simulation snapshots
