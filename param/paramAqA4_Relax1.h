	...
	#define SUBCAT_DIR  "/gpfs/data/jvbq85/HBT/data/AqA4/subcatRelax1"			//the output directory for subcatalogues and srccatalogues, this must be an existing directory
	...
	#define E_Relax 1  //(E_Relax+1)*pot+K<0
