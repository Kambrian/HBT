	...
	#define HALO_PARA
	/*=========program IO params==========*/
	//#define ROOT_DIR "/home/sussing/Working/HBT/Yang/256/"
	#define ROOT_DIR    "/gpfs/data/jvbq85/HBT/data/Yang256"
	...
	/*======simulation params===========*/
	#define NP_SIM	16777216 //total Number of all kinds of particles
	#define NP_GAS 	0
	#define NP_DM 	16777216
	#define BOXSIZE  8000.0  //kpc/h
	#define MP_DM    2.117538e-04
	#define MP_GAS   0.
	#define BOXHALF 4000.0

	/*=======Tree algorithm params========*/
	#define TREE_ALLOC_FACTOR 1//  MaxNodes = ((maxnodes>500)?maxnodes:500);
	#define ErrTolTheta 0.45
	#define SofteningHalo 0.04  //kpc/h
	#define NodeResolution 0.004  //0.1*Softening
	#define NodeReso_half 0.002
...
//	#define CONVERT_LENGTH_MPC_KPC //this tells to convert unit from Mpc to kpc, 
	...
	#define MaxSnap 51//total number of snapshot outputs
