	...
	#define SUBCAT_DIR  "/gpfs/data/jvbq85/HBT/data/AqA4/subcatRelaxInf"			//the output directory for subcatalogues and srccatalogues, this must be an existing directory
