...
//no satellite merger
...
#endif
	/*=========program IO params==========*/
	#define SUBCAT_DIR  "/home/kambrain/data/8213/subcatNSM"			//the output directory for subcatalogues and srccatalogues, this must be an existing directory
	...
	//~ #define GRPCAT_DIR  "/home/kambrain/sd8/8213/fof"				     //the input directory for GrpCatalogues
	//~ #define SNAPSHOT_DIR  "/home/kambrain/sd8/8213/simu"				//the input directory for simulation snapshots
	#define LOGFILE_NAME  "logfile"								//the name of program logfile, set to "stdout" to use stdout

	/*======simulation params===========*/
	#define NP_SIM	134217728 //total Number of all kinds of particles
	#define NP_GAS 0
	#define NP_DM 134217728
	#define BOXSIZE 100000.0
	#define MP_DM 0.0620373
	#define MP_GAS 0.
	/*=extension params=*/
...
// 	#define SAT_ACCR_ON      //define this to enable hierarchical accretion of satellite subs; comment this out to disable it
	...
	#define MaxSnap 60//total number of snapshot outputs
	#define RUN_NUM 8213	//simulation name
	#define SNAP_DIV_SCALE 1820 //last snapnum with scale
...
//obsolete	#define SNAPLIST        //define this if you use special snapshot_num rather than natural sequence
