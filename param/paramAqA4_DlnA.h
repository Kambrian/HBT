	...
	#define SUBCAT_DIR  "/gpfs/data/jvbq85/HBT/data/AqA4/subcatDlnA"			//the output directory for subcatalogues and srccatalogues, this must be an existing directory
	...
	#define MaxSnap 61//total number of snapshot outputs
