	...
	/*=========program IO params==========*/
	#define ROOT_DIR "/gpfs/data/jvbq85/HBT/data/AqD4"			//the output directory for gashalocat,gassubcat and gassrccat, this must be an existing directory
	...
	#define GRPCAT_DIR  "/gpfs/data/aquarius/halo_data/Aq-D/4"				//the input directory for GrpCatalogues
	#define  SNAPSHOT_DIR  "/gpfs/data/aquarius/halo_data/Aq-D/4"					//the input directory for simulation snapshots
	#define LOGFILE_NAME  "logfile"																			//the name of program logfile, set to "stdout" to use stdout

	/*======simulation params===========*/
	#define NP_SIM	21080428LL //total Number of all kinds of particles
	#define NP_GAS 	0
	#define NP_DM 20455156LL	
	#define BOXSIZE 	100.0  //Mpc/h
	#define MP_DM  1.954388e-05
	#define MP_GAS   0.
	...
	#define SofteningHalo 0.25e-3  //bug fix: from 0.3425 to 0.3425*h
	#define NodeResolution 0.025e-3  //0.1*Softening
	#define NodeReso_half 0.0125e-3
...
//	#define CONVERT_LENGTH_MPC_KPC //this tells to convert unit from Mpc to kpc, 
	...
	#define SNAPFILE_BASE "snap_9_14_39_400"
