...
frac,x=get_cum_distr(A1, fMinInfall, xbin, rmin, rmax)
plt.plot(xbin,frac, 'r-', label='A1')
frac,x=get_cum_distr(A2, fMinInfall, xbin, rmin, rmax)
...
plt.plot(xbin[xbin>xmin], frac[xbin>xmin], 'g-', label='Phoenix')
...
#plt.savefig(outdir+'/StripCDF.Phoenix.pdf')
'''
##plot profiles
Rref=1
iInfall=0
