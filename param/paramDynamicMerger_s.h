	...
	/*=========program IO params==========*/
        #define ROOT_DIR "/home/sgnworkshop/jiaxin/major_merger/dynamic_s"
	...
	/*======simulation params===========*/
	#define NP_SIM	156141 //total Number of all kinds of particles
	#define NP_GAS 	0
	#define NP_DM 	156141
	#define BOXSIZE 250.0
	//#define partmass=0.01
	#define MP_DM   0.198972
	...
	#define SofteningHalo 5.7e-3
	#define NodeResolution 5.7e-4  //0.1*Softening
	#define NodeReso_half 2.85e-4
...
//	#define CONVERT_LENGTH_MPC_KPC //this tells to convert unit from Mpc to kpc, 
	...
	#define MaxSnap 101//total number of snapshot outputs
	#define SNAPFILE_BASE "major_merger_dynamic"
