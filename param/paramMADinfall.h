	...
	/*=========program IO params==========*/
        #define ROOT_DIR "/home/kambrain/data2/MADHALOS/infall_full"
	...
	/*======simulation params===========*/
	#define NP_SIM	1567144 //total Number of all kinds of particles
	#define NP_gas 	0
	#define NP_DM 	1567144
	...
	#define SofteningHalo 3
	#define NodeResolution 0.3  //0.1*Softening
	#define NodeReso_half 0.15
	...
	#define MaxSnap 121//total number of snapshot outputs
	#define SNAPFILE_BASE "infall"
