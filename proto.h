...
extern HBTReal ComovingMean200Radius(HBTReal M200b, HBTReal OmegaM0);
...
//user_IO.c
extern int find_group_file(HBTInt Nsnap, char *GrpPath, int *grpfile_type);
extern int check_grpcat_byteorder(char *filename, int FileCounts);
extern void load_particle_header_i_into(HBTInt Nsnap, char *SnapPath, IO_HEADER *h, int ifile);
