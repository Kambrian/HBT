...
#endif
	/*=========program IO params==========*/
	#define ROOT_DIR    "/gpfs/data/jvbq85/HBT/data/BJLGR"
	...
	#define  SNAPSHOT_DIR  "/gpfs/data/bl267/test_ramses_fr/data/B250-PM1024/GR"	//the input directory for simulation snapshots
