function halo=readvirial_size(basedir,Nsnap,halotype)
%this function just read-in virial mass and virial radius
...
%         fseek(fid,13*4,'bof');
%         halo.mass0=fread(fid,1,'int32');%here just read first
        fseek(fid,14*4,'bof');
